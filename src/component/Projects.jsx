...
const Projects = () => {
    return (
        <div className="my-container py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-6">
            <div className="project-box">
                <div className=" w-full">
                <img src="https://i.ibb.co/D8nsF9J/Screenshot-2023-07-02-at-20-33-18-Life-Learning.png" alt="" className="w-full rounded-xl project-img "
                />
